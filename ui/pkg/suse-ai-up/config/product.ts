...
export const ROUTE_NAMES = {
  ...
  REGISTRY_SOURCES: `${PRODUCT}-c-cluster-${PAGE_TYPES.REGISTRY_SOURCES}`,
...
export const PAGES: PageDef[] = [
  ...
  { name: PAGE_TYPES.REGISTRY_SOURCES, label: 'Registry Sources', route: ROUTE_NAMES.REGISTRY_SOURCES, weight: 350 },
